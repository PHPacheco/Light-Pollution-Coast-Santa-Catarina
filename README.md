...
7. A relative ecological-risk layer was added to connect light exposure, marine buffers, habitat proxies, and fauna sensitivity.
...
- **Partially implemented:** Represent marine fauna presence with local sensitivity weights until OBIS is integrated:
...
- **Pending:** Replace fauna proxies with OBIS species richness and occurrence density.
...
- **Pending:** Cross results with CNUC/MMA:
  - coastal/marine protected areas;
  - APA da Baleia Franca;
  - REBIO Marinha do Arvoredo, when applicable.
- **Pending:** Use chlorophyll or primary productivity as a feeding-area proxy.
- **Pending:** Use AquaMaps only if OBIS has too few local records for a group.
...
The generated metrics are saved to `Data/ecological-risk/ecological_risk_metrics.csv`, and the explanation/validation reports are saved under `Reports/`.
